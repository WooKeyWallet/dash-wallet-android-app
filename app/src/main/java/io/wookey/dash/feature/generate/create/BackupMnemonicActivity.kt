package io.wookey.dash.feature.generate.create
...
import io.wookey.dash.dialog.BakMnemonicDialog
...
import io.wookey.dash.widget.SpaceItemDecoration
...
class BackupMnemonicActivity : BaseTitleSecondActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getMnemonic(walletId, password, seed)
