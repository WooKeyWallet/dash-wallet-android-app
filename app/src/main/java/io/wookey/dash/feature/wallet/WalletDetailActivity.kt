...
import io.wookey.dash.dialog.PasswordPromptDialog
import io.wookey.dash.feature.generate.WalletActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.wallet.observe(this, Observer { value ->
            value?.let {
                ...
                assetTitle.text = getString(R.string.asset_placeholder, "Dash")
